...
var routes = [
    ...
    { path: 'action/asset', component: asset_creation_component_1.AssetCreationComponent },
    { path: 'action/marketplace', component: market_place_component_1.MarketPlaceComponent },
    { path: 'action/insurer', component: insurer_creation_component_1.InsurerCreationComponent },
    { path: 'register/owner', component: owner_creation_component_1.OwnerRegisterComponent },
